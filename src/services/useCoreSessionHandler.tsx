...
export const useCoreSessionHandler = (
  contractdata: PageData<CoreSessionType>,
  session: Session | null,
  locale: Locale
) => {
  const [contracts, setCoreSessions] =
    useState<PageData<CoreSessionType>>(contractdata);
  ...
  const fetchData = async (
    ...
    try {
      ...
      const datacontract = contractdataApi.payload.dataresponse.fo[0]
        .input as PageData<CoreSessionType>;
      console.log("datacontract: ", datacontract);
      setCoreSessions(datacontract);
