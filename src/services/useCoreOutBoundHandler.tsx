...
export const useCoreOutboundHandler = (
  contractdata: PageData<CoreOutboundMessageType>,
  session: Session | null,
  locale: Locale
) => {
  const [contracts, setCoreOutbounds] =
    useState<PageData<CoreOutboundMessageType>>(contractdata);
  ...
  const fetchData = async (
    ...
    try {
      ...
      const datacontract = contractdataApi.payload.dataresponse.fo[0]
        .input as PageData<CoreOutboundMessageType>;
      console.log("datacontract: ", datacontract);
      setCoreOutbounds(datacontract);
