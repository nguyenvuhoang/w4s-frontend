...
export const exportToPDF = async (data: SMSContentType[]) => {
    ...
    doc.setTextColor(0, 128, 0) // xanh lá cây
    ...
    autoTable(doc, {
        ...
        headStyles: {
            fillColor: [17, 148, 85], // Màu xanh primary
        ...
        didDrawPage: (data) => {
            ...
            const pageNumber = doc.getNumberOfPages() // ✅ Sửa chỗ này
            doc.setFont(FONT_FAMILY, 'normal')
            doc.setFontSize(10)
            doc.text(
                `Page ${pageNumber}`,
