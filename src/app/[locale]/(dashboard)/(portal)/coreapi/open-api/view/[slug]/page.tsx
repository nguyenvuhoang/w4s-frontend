...
import OpenAPIViewContent from '@/views/api/open-api/view';
import { Metadata } from 'next';

export const metadata: Metadata = generateAuthMetadata('OpenAPI management view');

const OpenAPIView = async (props: {
    params: Promise<{
        locale: Locale,
        slug: string
    }>
    ...
    return (
        <OpenAPIViewContent session={session} dictionary={dictionary} locale={locale} openAPIdata={openAPIdata} />
    );
};
