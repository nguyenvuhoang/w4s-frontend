...
import CoreInboundViewContent from '@/views/nolayout/core-inbound/view'
...
const CoreInboundViewPage = async ({ params }: { params: Params }) => {
...
export default CoreInboundViewPage
