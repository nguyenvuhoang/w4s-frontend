...
import CoreSessionViewContent from '@/views/nolayout/core-session/view'
...
const CoreSessionViewPage = async ({ params }: { params: Params }) => {
...
export default CoreSessionViewPage
