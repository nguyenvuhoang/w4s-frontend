...
import CoreOutboundViewContent from '@/views/nolayout/core-outbound/view'
...
const CoreOutboundViewPage = async ({ params }: { params: Params }) => {
...
export default CoreOutboundViewPage
