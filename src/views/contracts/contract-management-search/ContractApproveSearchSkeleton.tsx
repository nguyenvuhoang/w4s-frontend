...
interface ContractApproveSearchSkeletonProps {
    dictionary: Awaited<ReturnType<typeof getDictionary>>
}

const ContractApproveSearchSkeleton = ({ dictionary }: ContractApproveSearchSkeletonProps) => {
    const rowsCount = 10
...
export default ContractApproveSearchSkeleton
