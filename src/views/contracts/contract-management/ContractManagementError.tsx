...
interface ContractManagementErrorProps {
    executionId?: string
    errorInfo?: string
    errorMessage?: string
...
const ContractManagementError = ({ executionId, errorInfo, errorMessage, dictionary }: ContractManagementErrorProps) => {
    return (
            ...
            <Box mt={3}>
                ...
                >
                    <AlertTitle sx={{ fontWeight: 600, fontSize: '1.1rem' }}>
                        {dictionary.contract?.error_load_title ?? 'Failed to Load Contract Data'}
                    </AlertTitle>
                    
                    <Box sx={{ mt: 1 }}>
                        <Typography variant="body2" component="div" sx={{ mb: 1 }}>
                            {dictionary.contract?.error_load_message ?? 'An error occurred while fetching contract management data. Please try again later or contact support if the problem persists.'}
                        </Typography>
...
export default ContractManagementError
