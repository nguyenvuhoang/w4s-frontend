...
const contractFields: { key: keyof Contract; label: string; isdate?: boolean }[] = [
    { key: 'contractnumber', label: 'Contract Number' },
    { key: 'customercode', label: 'Customer Code' },
    { key: 'contracttypecaption', label: 'Contract Type' },
    { key: 'usertype', label: 'User Type' },
    { key: 'createdate', label: 'Create Date', isdate: true },
                        ...
                        <Grid size={{ xs: 12, md: 6 }}
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {field.isdate
                                            ? formatDateTime(contractdata[field.key] as string)
