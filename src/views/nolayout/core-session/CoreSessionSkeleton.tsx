...
interface CoreSessionSkeletonProps {
  dictionary: Dictionary
}

const CoreSessionSkeleton = ({ dictionary }: CoreSessionSkeletonProps) => {
  return (
    <Box p={5}>
      {/* Search Field */}
      <Box display="flex" alignItems="center" gap={4} mb={4}>
        <TextField
          disabled
          size="small"
          placeholder={dictionary["coresession"].loginname}
          sx={{ width: '300px' }}
        />
...
export default CoreSessionSkeleton
