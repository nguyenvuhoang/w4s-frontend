  ...
  useEffect(() => {
    const href =
      ...
      (component &&
        ...
        'props' in component &&
        typeof (component as { props?: unknown }).props === 'object' &&
        (component as ReactElement).props &&
        typeof (component as ReactElement).props === 'object' &&
        Object.prototype.hasOwnProperty.call((component as ReactElement).props, 'href') &&
        (component as ReactElement).props &&
