  ...
  useEffect(() => {
    const href =
      ...
      (component &&
        ...
        (React.isValidElement(component) && 'href' in (component.props as any)
          ? (component.props as { href?: string }).href
          : undefined))
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Menu Item Label */}
        <StyledMenuLabel
          className={classnames(menuClasses.label, { [menuClasses.active]: active })}
